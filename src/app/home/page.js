    ...
    <>
      ...
      {step === 'select' && (
        <div style={{ position: 'absolute', inset: 0, animation: 'trFade .3s ease', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ background: 'var(--bg)', borderTopLeftRadius: '24px', borderTopRightRadius: '24px', zIndex: 10, display: 'flex', flexDirection: 'column', boxShadow: '0 -4px 20px rgba(0,0,0,0.1)' }}>
            <div style={{ width: '40px', height: '4px', background: '#e0e0e0', borderRadius: '2px', margin: '12px auto' }}></div>
            
            <div className="tr-sb" style={{ maxHeight: '45vh', overflowY: 'auto', padding: '0 16px' }}>
            ...
            <div style={{ padding: '16px', borderTop: '1px solid var(--sf)' }}>
