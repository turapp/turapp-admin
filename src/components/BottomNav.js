...
export default function BottomNav() {
  ...
  return (
    <div style={{ position: 'fixed', bottom: 0, left: '50%', transform: 'translateX(-50%)', width: '100%', maxWidth: '450px', height: '80px', background: 'var(--bg)', borderTop: '1px solid var(--bd)', display: 'flex', alignItems: 'center', justifyContent: 'space-around', zIndex: 100, paddingBottom: '10px', transition: 'background 0.3s ease, border 0.3s ease' }}>
      {tabs.map((tab) => {
